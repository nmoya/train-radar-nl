...
def health(request: Request) -> HealthResponse:
    ...
    return HealthResponse(
        ...
        app_config=AppConfigResponse(
            ...
            target_passage_tolerance_floor_seconds=config.target_passage_tolerance_floor_seconds,
            target_passage_tolerance_factor=config.target_passage_tolerance_factor,
            target_passage_directional_tolerance_factor=config.target_passage_directional_tolerance_factor,
            target_passage_alert_lead_seconds=config.target_passage_alert_lead_seconds,
